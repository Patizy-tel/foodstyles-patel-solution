...
export class DietsService {
  ...
  async populateDiets(): Promise<any> {
    ...
    for (const iterator of diets) {
      const packet = {
        name: iterator.name,
      };
      await this.createDiet(packet);
    }
  }
}
